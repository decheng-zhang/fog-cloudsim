...
public class Cloudlet {
	...
	/** The coordination position of Cloudlet request. */
	private double xAxis;
	
	/** The coodination postion of Cloudlet Requst. */
	...
	public Cloudlet(
		...
		this.setxAxis(xPosition);
		this.setyAxis(yPosition);
	...
	public boolean recycleCloudlet() {
		if() {
