...
import dehelper.GlobalBroker;
import dehelper.KmeanFogletAllocator;
...
public class CloudSimExample8 {
	...
	static List<Vm> createVM(int userId, int vms, int idShift) {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Log.printLine("\n\n\n" + CloudSim.clock() + "GlobalBroker Initialization");
			...
			//Log.printLine("broker list");
			//printCloudletList(broker.getCloudletList());
			//printCloudletList(broker.getCloudletSubmittedList());
			//Log.printLine("=================");
			...
			//Iterator<DatacenterBroker> Iter = globalBroker.getBroker().iterator();
			
			//while(Iter.hasNext()) {
			//	newList.addAll(Iter.next().getCloudletReceivedList());
			//}
