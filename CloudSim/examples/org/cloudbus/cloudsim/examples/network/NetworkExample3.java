...
public class NetworkExample3 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			cloudletList1 = createCloudletBatch(10,brokerId1);

			//Cloudlet cloudlet1 = new Cloudlet(id, length, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel);
			//cloudlet1.setUserId(brokerId1);
			
			//Log.printLine(cloudlet1.getxAxis()+","+cloudlet1.getyAxis());
			...
			Log.printLine("Showing network-topologyyy");
			Log.printLine(NetworkTopology.printOutGraph());
	...
	/**
	 * Create centain number of Cloudlets(Randam location)
	 * @param list cloudletContainer
	 * @param num num of cloudlet need to be created
	 * @param brokerId belonging to which borker
	 */
	private static List<Cloudlet> createCloudletBatch(int num, int brokerId) {
