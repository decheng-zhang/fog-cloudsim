 ...
 */
public abstract class RunnerAbstract2 {

	/** The enable output. */
	private static boolean enableOutput;

	/** The broker. */
	protected static List<? extends DatacenterBroker> broker;
	...
	public RunnerAbstract2(
		...
		init(inputFolder + File.separator + workload);
		start(
	...
	protected void start(String experimentName, String outputFolder, VmAllocationPolicy vmAllocationPolicy) {
		...
		try {
			...
			CloudSim.terminateSimulation(FogConst.SIMULATION_LIMIT);
	...
	public void setEnableOutput(boolean enableOutput) {
		RunnerAbstract2.enableOutput = enableOutput;
	}
